/*
    ...
    you determine if a given string, , is a palindrome?
    ...
    A char popCharacter() method that pops and returns the character at the top of the queue instance variable.
    ...
    otherwise, it will print The word, racecar, is not a palindrome.
...
public class Solution {
    ...
    private Stack<Character> stackChar = new Stack<>();
    private Queue<Character> queueChar = new LinkedList<>();
